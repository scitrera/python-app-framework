...
class Variables2(object):
    ...
    def environ(self, key: str, default=NOT_SET, type_fn: Callable = None):
        """
    ...
    def import_from_env_by_prefix(self, prefix: str, sep='_', drop_prefix=True, prefix_lower=False, key_lower=True) -> dict[str, Any]:
        """
    ...
    def get_or_set(self, key: str, default_fn: callable) -> Any:
        """
        Convenience function to cover a common pattern. This function searches the LOCAL data for the given key
        and will populate it by calling the provided no-arg default_fn if it does not exist in the local data.
        ...
        :param default_fn: a no-arg function that will be called to provide a default if the key is not found
